...
mongodb.MongoClient.connect(process.env.MONGODB_URI || "mongodb+srv://vrhouse:<m123456>@cluster0-rwpma.mongodb.net/test?retryWrites=true", function (err, database) {
  if (err) {
    console.log(err);
    process.exit(1);
  }
